            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <ol class="breadcrumb mb-4">
                         <a href="employee.php"><button type="button" id="join-btn">Add Employee</button></a> 
                    </ol>
					...
					<td><a href="update.php"><button id="join-btn" data-toggle="modal" type="button" data-target="#update_modal<?php echo $customer['id']?>"><span class="glyphicon glyphicon-edit"></span>edit  </button></a>
                </td>
				                </tr>
				<?php endforeach; ?>
