...
$(document).on('click','.editbtn', function(event)
{
    ...
    $.ajax({
        ...
        success: function(data){
            var json = JSON .parse(data);
            $('id').val(json.id);
            $('#_Inputfirst_name').val(json.first_name);
            $('#_Inputlast_name').val(json.last_name);
            $('#_Inputdepartment_name').val(json.department_name);
            $('#_ position').val(json.position);
...
<div class="mb-3">
    ...
    <input type="text" name="first_name" class="form-control" id="exampleInputFirst_name">
    
  </div>
<div class="mb-3">
    <label for="Inputlast_name" class="form-label">last_name</label>
    <input type="text" name="last_name" class="form-control" id="exampleInputlast_name">
     
  </div>
<div class="mb-3">
    <label for="Inputdepartment_name" class="form-label">department</label>
   <select class="form-select" aria-label="Default select example" id="exampleInputdepartment_name">
...
<div class="mb-3">
    <label for="InputFirst_name" class="form-label">first_name</label>
    <input type="text" name="_first_name" class="form-control" id="_InputFirst_name">
    
  </div>
<div class="mb-3">
    <label for="Inputlast_name" class="form-label">last_name</label>
    <input type="text" name="_last_name" class="form-control" id="_Inputlast_name">
     
  </div>
<div class="mb-3">
    <label for="Inputdepartment_name" class="form-label">department</label>
   <select class="form-select" aria-label="Default select example" id="_Inputdepartment_name" name="_department_name">
  <option selected>Open this select  Staff deapartment</option>
  <option value="1">Corporate</option>
  <option value="2">Minister</option>
  <option value="3">Financial</option>
 ...
 <div class="mb-3">
    <label for="Inputposition" class="form-label">Position</label>
    <input type="text"  name="_position" class="form-control" id="_Inputposition">
