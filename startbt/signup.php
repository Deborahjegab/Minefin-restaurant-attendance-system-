...
<body class="sb-nav-fixed">
  ...
  <div class="info">
    ...
    <p>Register Here</p>
   <a href="users.php">    <button type="submit"  name="submit" id="join-btn" alt="Submit"  >View system users</button></a>
  </div>
  <form action="#" method="POST" class="signupForm" name="signupform">
    ...
    <ul class="noBullet">
      <li>
        ...
        <input type="text" class="inputFields" id="username" name="name" placeholder="Username" value="" oninput="return userNameValidation(this.value)" required/>
      </li>
      ...
      <li>
       ...
       <li>
        ...
        <input type="password" class="inputFields" id="cpassword" name="cpassword" placeholder="confirm your Password" value="" oninput="return passwordValidation(this.value)" required/>
      </li>
      <li>
         <label for="user_type"></label>
        <select name="user_type"  class="inputFields" style="background-color: white;">
